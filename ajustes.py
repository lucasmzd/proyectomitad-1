...
def administrar_botones(boton_suma:dict,boton_resta:dict,boton_volver:dict,boton_personalizada:dict,datos_juego:dict,pos_mouse:tuple) -> str:
    ventana = "ajustes"
...
def dibujar_elementos(pantalla:pygame.Surface,boton_suma:dict,boton_resta:dict,boton_volver:dict,boton_personalizada:dict,datos_juego:dict) -> None:
...
def mostrar_ajustes(pantalla:pygame.Surface,cola_eventos:list[pygame.event.Event],datos_juego:dict) -> str:
    ...
    for evento in cola_eventos:
        if evento.type == pygame.MOUSEBUTTONDOWN and evento.button == 1:
            ventana = administrar_botones(boton_suma,boton_resta,boton_volver,boton_personalizada,datos_juego,evento.pos)
    dibujar_elementos(pantalla,boton_suma,boton_resta,boton_volver,boton_personalizada,datos_juego)
    return ventana